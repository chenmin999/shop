	...
	<div class="container">
		<div class="row">
						...
						<c:forEach items="${orders.itemList}" var="orderItem">
							<tr class="active">
								<td width="60" width="40%">
									...
									<img src="${path}/${orderItem.product.pimage}" width="70" height="60">
								</td>
			...
			<div style="text-align: right; margin-right: 120px;">
				商品总金额: <strong style="color: #ff6600;">￥${orders.total}元</strong>
			</div>
		...
		<div>
			...
			<form class="form-horizontal" id="orderForm" style="margin-top: 5px; margin-left: 150px;" action="${path}/order?method=confirmOrder" method="post">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="address" name="address" value="${user.address}" placeholder="请输入收货地址">
					</div>
				</div>
				<div class="form-group">
					<label for="username" class="col-sm-1 control-label">收货姓名</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="username" name="name" value="${user.username}" placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
					<label for="telephone" class="col-sm-1 control-label">收货电话</label>
					<div class="col-sm-5">
